<x-layouts.app title="Profile">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h2 class="text-[22px] font-extrabold text-slate-800 tracking-tight leading-none">
                {{ $user->name }}
            </h2>
            ...
            <div class="flex items-center gap-2 mt-1.5">
                ...
                <span class="text-[12px] text-slate-400">
                    Bergabung {{ $user->created_at->locale('id')->isoFormat('D MMMM Y') }}
                </span>
            </div>
        </div>
    </div>
        ...
        <div class="lg:col-span-1 space-y-4">
            ...
            <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden">
                <div class="px-5 py-4 border-b border-slate-100">
                    <div class="text-[14px] font-bold text-slate-800 tracking-tight">
                        Informasi Akun
                    </div>
                </div>
            ...
            <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden">
                ...
                <div class="divide-y divide-slate-50">
                    ...
                    @if ($autoCheckouts > 0)
                        <div class="flex items-center justify-between px-5 py-3.5">
                            <div class="flex items-center gap-2.5">
                                <div class="w-8 h-8 rounded-[8px] bg-red-50 flex items-center justify-center text-sm">
                                    ⚠️
                                </div>
                            ...
                            <span class="text-[15px] font-extrabold text-red-500">
                                {{ $autoCheckouts }}
                            </span>
                        </div>
                    @endif
                            ...
                            <tr class="hover:bg-brand-50/40 transition-colors">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    ...
                                    @elseif(!$att->checkout_time)
                                        <span class="text-[12px] text-amber-500 font-medium">
                                            Berlangsung
                                        </span>
                                    @else
