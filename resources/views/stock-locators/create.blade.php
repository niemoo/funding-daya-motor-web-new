<x-layouts.app title="Tambah Stock Locator">
    <div class="max-w-2xl">
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                <h1 class="text-[20px] font-extrabold text-slate-800 tracking-tight">Tambah Stock Locator</h1>
                <p class="text-[13px] text-slate-400 mt-0.5">Tambah data lokasi stock baru</p>
            </div>
        </div>

        <div class="bg-white border border-slate-200 rounded-2xl p-6">
            <form method="POST" action="{{ route('stock-locators.store') }}" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="lokasi_stock" value="{{ old('lokasi_stock') }}"
                        placeholder="Contoh: A1 POJOK"
                        class="w-full px-3.5 py-2.5 bg-slate-50 border-[1.5px] rounded-[10px] text-[13px] font-mono text-slate-800 outline-none transition-all placeholder-slate-400
