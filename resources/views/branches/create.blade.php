<x-layouts.app title="Tambah Cabang">
    <div class="max-w-xl">
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                <h1 class="text-[20px] font-extrabold text-slate-800 tracking-tight">Tambah Cabang</h1>
                <p class="text-[13px] text-slate-400 mt-0.5">Tambah data cabang baru</p>
            </div>
        </div>
        <div class="bg-white border border-slate-200 rounded-2xl p-6">
            <form method="POST" action="{{ route('branches.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="kode_cabang" value="{{ old('kode_cabang') }}"
