<x-layouts.app title="Tambah User">
    ...
    <div class="max-w-xl">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                <h1 class="text-[20px] font-extrabold text-slate-800 tracking-tight">Tambah User</h1>
                <p class="text-[13px] text-slate-400 mt-0.5">Buat akun pengguna baru</p>
            </div>
        </div>
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-6">
            <form method="POST" action="{{ route('users.store') }}" class="space-y-5">
                ...
                {{-- Konfirmasi Password --}}
                <div>
                    <label class="block text-[13px] font-semibold text-slate-600 mb-1.5">Konfirmasi Password</label>
