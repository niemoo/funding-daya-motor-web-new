<x-layouts.app title="Tambah Role">
    <div class="max-w-2xl">
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                <h1 class="text-[20px] font-extrabold text-slate-800 tracking-tight">Tambah Role</h1>
                <p class="text-[13px] text-slate-400 mt-0.5">Buat role baru dan atur permissions-nya</p>
            </div>
        </div>
            ...
            <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden">
                <div class="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-[12px] text-slate-400 mt-0.5">Pilih akses yang diberikan ke role ini</div>
                    </div>
